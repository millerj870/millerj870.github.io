...
NOTE: One graphic is required for certain questions in section G7A


## Colophon

This document was created from the 2019-2023 question pool for the general class amateur radio license available at  [http://www.ncvec.org/downloads/2019-2023GeneralClassQuestionPool.txt](http://www.ncvec.org/downloads/2019-2023GeneralClassQuestionPool.txt), downloaded on 23 July 2021.  

The questions were reformatted algorithmically, then the resulting document was edited by hand by

* accounting for the pool's errata, available at [http://www.ncvec.org/page.php?id=364](http://www.ncvec.org/page.php?id=364),
* adding [the image](http://www.ncvec.org/downloads/G7-1.jpg) for questions in G7-1,
* replaceing a unicode character for a quotation mark with an ASCII character for the same, and 
* adding this colophon.

This modified document was created by Jason Miller KM6PSZ.  The above process is documented in a blog post ["Regular Expressions and Preparing for the General Class Amateur Radio License Exam"](http://thecoldfish.com/2021/07/25/regex-ham-general-question-pool.html).
